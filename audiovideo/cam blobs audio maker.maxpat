...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 801.0, 208.0, 50.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 516.0, 147.0, 41.0, 20.0 ],
					"text" : "metro"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 928.0, 490.5, 74.0, 198.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 611.75, 111.0, 32.5, 20.0 ],
					"text" : "* 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 775.0, 417.5, 36.0, 21.0 ],
					"text" : "+ 10"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 451.0, 549.5, 45.0, 45.0 ],
					"presentation" : 1,
